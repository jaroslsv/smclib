...
Simulate how component tolerances stack up and affect your design. No statistical theory required — just define your equation and your tolerances.
...
### The Problem
You're designing an assembly with multiple parts, each with tolerances (e.g., 5H7, ±0.05 mm, angles, etc.). What's the probability that parts will interfere? Or what's the output range of your mechanism?

**Traditional methods:** Complex formulas, manual worst-case stacking, or expensive specialized software.
